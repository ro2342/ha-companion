...
PNGs em uwp/HaCompanionUWP/Assets/ com a convenção de nome scale-N que o
empacotador do UWP reconhece automaticamente. Adaptado do mesmo script em
theartistsway/uwp/ArtistWayUWP/generate_tile_assets.py.
"""
import io
import os
